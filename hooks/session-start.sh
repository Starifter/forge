...
if [ -f "$SETTINGS_PATH" ]; then
  ...
  SETTINGS_CONTENT='{"pluginConfigs":{"forge":{"options":{"tdd_mode":false,"auto_research":true,"strict_wave_review":false,"worktree_default":"","auto_clean":false,"verify_per_wave":false,"auto_execution_mode":"sequential","auto_max_fix_attempts":3}}}}'
fi
